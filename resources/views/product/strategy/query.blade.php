...
?>
          <table class="table table-bordered b-t b-light">
            <thead>
              <tr>
                ...
                <th><?php if(isset(Strategy::$fieldsMap[$v])) echo Strategy::$fieldsMap[$v]['name']; else echo $v; ?></th>
                <?php endforeach; ?>
              ...
              <tr>
                ...
                <td>
                    <div class="previewimg">
                        <img src="<?= $v1 ?>" style="width:30px;height:30px;margin:1px;"/>
                    </div>
                </td>
                <?php else : ?>
                <td><?= $v1 ?></td>
          ...
          <div style="display:none;" class='row'>
             	...
             	<input type="hidden" id="requestUrl"  value="<?= url("strategy/postquery") ?>">
