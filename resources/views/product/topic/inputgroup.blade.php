...
?>
        ...
        <form action="<?= url('topic/postquery') ?>" method="post" id="query_form">
            ...
            <div class="form-group pull-in clearfix">
                ...
                if(isset(Topic::$fieldsMap[$v])) {       //Fields Map
                    $v1=Topic::$fieldsMap[$v]['name'];   //Fields Name
                    $desc=Topic::$fieldsMap[$v]['desc']; //Fields Desc
                    $v3="";
                ...
                <div class="">
                  ...
                  <ul class="dropdown-menu dropdown-select">
                    ...
                    <?php foreach (Constant::$topicTypeMap as $key=> $val) :?>
                	<li class="">
                      <input type="radio" name="<?= $v ?>" value="<?= $key ?>">
                      <a href="#" title='<?= $val ?>'><?= $key ?></a>
                    </li>
             		<?php endforeach;?>
                  </ul>
                  </div>
