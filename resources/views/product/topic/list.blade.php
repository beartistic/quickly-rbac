...
var hanlder = function(that){
  var requestUrl = "<?= url("topic/postquery") ?>";
...
////Add
var hanlder = function(that){
  var requestUrl = "<?= url("topic/postadd") ?>";
  var params = getParams();
...
var hanlder = function(that){
  ...
  var requestUrl = "<?= url("topic/postrow") ?>";
  var tableColumns = $("#tableColumns").val();
...
var hanlder = function(that){
  var requestUrl = "<?= url("topic/postupdate") ?>";
  var tableColumns = $("#tableColumns").val();
  var params = getParams();
  var content = {"name":"img_item_map","value":$(".wysiwyg_content").val()};
  params.push(content);
...
////Remove Confirm
var hanlder = function(that) {
  var requestUrl = "<?= url("topic/postdelete") ?>";
  var tableColumns = $("#tableColumns").val();
  var params = getParams();
  $.ajax({
    "url": requestUrl,
