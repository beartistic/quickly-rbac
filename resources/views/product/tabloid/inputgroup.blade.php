...
?>
        ...
        <form action="<?= url('article/postquery') ?>" method="post" id="query_form">
            ...
            <div class="form-group pull-in clearfix">
                ...
                if(isset(Tabloid::$fieldsMap[$v])) {       //Fields Map
                    $v1=Tabloid::$fieldsMap[$v]['name'];   //Fields Name
                    $desc=Tabloid::$fieldsMap[$v]['desc']; //Fields Desc
                    $v3="";
          ...
          <div class="form-group pull-in clearfix">
          	<div class="">
                ...
                <div class="col-sm-12">
                        ...
                        <div id="editor" class="form-control wysiwyg_content" placeholder="Go ahead" style="overflow:scroll;height:400px;max-height:500px">
