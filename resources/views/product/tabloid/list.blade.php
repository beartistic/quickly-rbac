...
var hanlder = function(that){
  var requestUrl = "<?= url("tabloid/postquery") ?>";
...
////Add
var hanlder = function(that){
  var requestUrl = "<?= url("tabloid/postadd") ?>";
  var params = getParams();
...
var hanlder = function(that){
  ...
  var requestUrl = "<?= url("tabloid/postrow") ?>";
  var tableColumns = $("#tableColumns").val();
...
var hanlder = function(that){
  var requestUrl = "<?= url("tabloid/postupdate") ?>";
  var tableColumns = $("#tableColumns").val();
  var params = getParams();
  var content = {"name":"content","value":$(".wysiwyg_content").html()};
  params.push(content);
...
////Remove Confirm
var hanlder = function(that) {
  var requestUrl = "<?= url("tabloid/postdelete") ?>";
  var tableColumns = $("#tableColumns").val();
  var params = getParams();
  $.ajax({
    "url": requestUrl,
