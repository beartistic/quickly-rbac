...
var hanlder = function(that){
  var requestUrl = "<?= url("userrole/postquery") ?>";
...
////Add
var hanlder = function(that){
  var requestUrl = "<?= url("userrole/postadd") ?>";
  var params = getParams();
...
var hanlder = function(that){
  ...
  var requestUrl = "<?= url("userrole/postrow") ?>";
  var tableColumns = $("#tableColumns").val();
...
var hanlder = function(that){
  var requestUrl = "<?= url("userrole/postupdate") ?>";
  var tableColumns = $("#tableColumns").val();
  var params = getParams();
  $.ajax({
    "url": requestUrl,
...
////Remove Confirm
var hanlder = function(that) {
  var requestUrl = "<?= url("userrole/postdelete") ?>";
  var tableColumns = $("#tableColumns").val();
  var params = getParams();
  $.ajax({
    "url": requestUrl,
...
var hanlder = function(that) {
	...
	$("#query_form").find("input[name='id']").val(id);
	//set modal
	$("#mymodel .model_body_txt").text("您确定要删除当前用户权限吗？");
}
