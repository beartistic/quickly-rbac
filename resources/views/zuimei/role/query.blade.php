...
?>
          <table class="table table-bordered b-t b-light">
            <thead>
              <tr>
                ...
                <th><?php if(isset(Role::$fieldsMap[$v])) echo Role::$fieldsMap[$v]['name']; else echo $v; ?></th>
                <?php endforeach; ?>
            ...
            <?php foreach ($records as $k=> $v): ?>
              <tr>
                ...
                <td style="text-align:center;">
                  <a class="btn btn-rounded btn-sm btn-icon btn-default roleSetting" href="<?= url('role/setting', array('id'=>$v->id))?>"><i class="icon-settings"></i></a>
          ...
          <div style="display:none;" class='row'>
             	...
             	<input type="hidden" id="requestUrl" value="<?= url("role/postquery") ?>">
