...
var hanlder = function(that){
  var requestUrl = "<?= url("role/postquery") ?>";
...
////Add
var hanlder = function(that){
  var requestUrl = "<?= url("role/postadd") ?>";
  var params = getParams();
...
var hanlder = function(that){
  ...
  var requestUrl = "<?= url("role/postrow") ?>";
  var tableColumns = $("#tableColumns").val();
...
var hanlder = function(that){
  var requestUrl = "<?= url("role/postupdate") ?>";
  var tableColumns = $("#tableColumns").val();
  var params = getParams();
  $.ajax({
    "url": requestUrl,
...
////Remove Confirm
var hanlder = function(that) {
  var requestUrl = "<?= url("role/postdelete") ?>";
  var tableColumns = $("#tableColumns").val();
  var params = getParams();
  $.ajax({
    "url": requestUrl,
