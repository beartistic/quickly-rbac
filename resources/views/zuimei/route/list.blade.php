...
var hanlder = function(that){
  var requestUrl = "<?= url("route/postquery") ?>";
...
////Add
var hanlder = function(that){
  var requestUrl = "<?= url("route/postadd") ?>";
  var params = getParams();
...
var hanlder = function(that){
  ...
  var requestUrl = "<?= url("route/postrow") ?>";
  var tableColumns = $("#tableColumns").val();
...
var hanlder = function(that){
  var requestUrl = "<?= url("route/postupdate") ?>";
  var tableColumns = $("#tableColumns").val();
  var params = getParams();
  $.ajax({
    "url": requestUrl,
...
////Remove Confirm
var hanlder = function(that) {
  var requestUrl = "<?= url("route/postdelete") ?>";
  var tableColumns = $("#tableColumns").val();
  var params = getParams();
  $.ajax({
    "url": requestUrl,
